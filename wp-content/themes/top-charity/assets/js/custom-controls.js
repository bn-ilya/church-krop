...
(function(api) {
    ...
    api.sectionConstructor['top-charity-upsell'] = api.Section.extend({
    ...
    const top_charity_section_lists = ['banner', 'about', 'service', 'causes', 'cta', 'team', 'blog', 'contact'];
    top_charity_section_lists.forEach(top_charity_homepage_scroll);

    function top_charity_homepage_scroll(item, index) {
        // Detect when the front page sections section is expanded (or closed) so we can adjust the preview accordingly.
        item = item.replace(/-/g, '_');
        wp.customize.section('top_charity_' + item + '_section', function(section) {
